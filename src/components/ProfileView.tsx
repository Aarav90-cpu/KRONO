...
export const ProfileView: React.FC<ProfileViewProps> = ({
  ...
  return (
    <div className="w-full max-w-3xl mx-auto flex flex-col gap-6 pb-12">
      {/* Top Bar */}
      <div className="flex items-center gap-3 p-4 rounded-xl bg-surface border border-border-glass-dark">
        <button
            ...
            <div className="flex flex-col gap-2">
              <div>
                <div className="flex items-center gap-1.5">
                  <h2 className="text-lg font-bold text-on-surface">Aarav</h2>
                  <CheckCircle className="w-4 h-4 text-primary fill-primary/20" />
                </div>
                <span className="text-xs text-outline font-mono">@aarav</span>
              </div>
